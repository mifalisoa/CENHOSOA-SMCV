...
router.put(   '/:id/permissions', roleMiddleware(['admin']), (req, res, next) => controller.setPermissions(req, res, next));
router.delete('/:id/permissions', roleMiddleware(['admin']), (req, res, next) => controller.resetPermissions(req, res, next));
