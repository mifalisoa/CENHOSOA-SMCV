        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#08C5D1] focus:border-transparent outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="exemple@cenhosoa.mg"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#08C5D1] focus:border-transparent outline-none"
                />
                <button
                  type="button"
          ...
          <div className="flex items-center justify-end gap-3 mt-6 pt-4 border-t">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="px-6 py-2 bg-[#08C5D1] text-white rounded-lg font-semibold hover:bg-[#06B3BF] transition-colors disabled:opacity-50"
            >
